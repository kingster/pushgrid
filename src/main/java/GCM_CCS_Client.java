...
public class GCM_CCS_Client {
	...
	public void connect(String username, String password) throws XMPPException {
		...
		connection.addConnectionListener(new ConnectionListener() {
			...
			public void reconnectingIn(int seconds) {
				logger.log(Level.INFO, "Reconnecting in {} secs", seconds);
			}
	...
	public static void main(String [] args) {
		final String userName = "<projectId>@gcm.googleapis.com";
		final String password = "<apiKey>";

		GCM_CCS_Client ccsClient = new GCM_CCS_Client();
		...
		try {
			...
			String toRegId = "APA91bEOj1kHQWFOeCFp5o5vTxkTRdkwweGAY-H7Sba4sTQlIncdxKIW17_X-HzQ5quRG1sGdgDv-xo2IvLyiJkM9vHiy2uUTmLo4895EzWdTgeo5gVJYrZ09C7x4NWcIqIRt2mMLkaV2b7aO2FY_5ftlOUcHqA6lg";
			String messageId = ccsClient.getRandomMessageId();
			Map<String, String> payload = new HashMap<String, String>();
			payload.put("title", "hello world");
			payload.put("message", "Dummy Message gcm ccc");
